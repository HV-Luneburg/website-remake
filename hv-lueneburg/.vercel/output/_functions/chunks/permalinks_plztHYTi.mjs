...
const SITE = {"name":"HV Lüneburg","site":"https://astrowind.vercel.app","base":"/","trailingSlash":false,"googleSiteVerificationId":""};
                    const I18N = {"language":"de","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"HV Lüneburg","template":"%s — HV Lüneburg"},"description":"Handballverein Lüneburg — Dein Verein für Handball in Lüneburg und Umgebung.","openGraph":{"type":"website","site_name":"HV Lüneburg","images":[{"url":"~/assets/images/default.png","width":1200,"height":628}]}};
                    const APP_BLOG = {"postsPerPage":6,"post":{"permalink":"news/%slug%","robots":{"index":true,"follow":true}},"list":{"pathname":"news","robots":{"follow":true}},"category":{"pathname":"category","robots":{"index":true,"follow":true}},"tag":{"pathname":"tag","robots":{"index":false,"follow":true}}};
